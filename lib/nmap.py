...
class PortScanner(object):
    ...
    def scan(self, path, ports=None, arguments='-sV'):
        """
        Scan given hosts
        ...
        args = 'sudo nmap -oX - -T4 -sS --script=http-title -p 1-1000 -iL ' + path
        print args
        p = subprocess.Popen(args, bufsize=100000, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE,shell=True)
